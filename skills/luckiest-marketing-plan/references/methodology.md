...
Set `phase: finalized` in `progress.md` and stamp `last_updated`. This is the terminal state and prevents future `/luckiest-marketing-plan` invocations from silently overwriting the plan (see Step 1.1.2 case 6).
