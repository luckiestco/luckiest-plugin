...
Every site built with **luckiest-design-website** gets one row here, appended after it
...
Claimed by `luckiest-design-website-showcase`, so also now taken:
...
- **Grammar:** gallery / catalog. Two grammars remain unclaimed (split stage; typographic poster went to `luckiest-design-website-showcase` in the same week).
...
- **Shared ground:** it shares cobalt, bone, and condensed grotesk type with
  `luckiest-design-website-showcase`; full-bleed generated photography with the early filmic
