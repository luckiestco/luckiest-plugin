...
- [ ] Sample Ratio Mismatch (SRM) check scheduled for analysis
...
## Data Quality (check first, before reading metrics)
| Check | Result |
|-------|--------|
| Sample Ratio Mismatch (SRM)? | Pass / Fail (if fail, STOP and investigate) |
| Expected vs. actual split | [50/50 vs. observed] |
