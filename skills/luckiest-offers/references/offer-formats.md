...
- **Pricing tier > offer construction** — for self-serve SaaS, packaging and value metric do more work than guarantees and bonuses. Use the `luckiest-pricing` skill.
...
For SaaS, this skill is supplemental. Read [`luckiest-pricing`](../luckiest-pricing/SKILL.md) first.
