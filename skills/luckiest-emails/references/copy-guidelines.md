...
### Deliverability and Consent (design constraint, not an afterthought)
- Authenticate the sending domain (SPF, DKIM, DMARC) before any bulk send
- Warm up new domains/IPs gradually
- Every email needs a working, one-click unsubscribe and a physical address
- Honor consent basis (CAN-SPAM, GDPR/PECR) for the recipient's region
- Frequency-cap across overlapping sequences so no subscriber is over-mailed
