...
Before shipping a list to the user (or downstream to luckiest-cold-email):
...
- [ ] First outreach will include unsubscribe + privacy notice (downstream concern for luckiest-cold-email skill, but mention it now)
