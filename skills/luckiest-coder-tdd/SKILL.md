---
name: luckiest-coder-tdd
description: Use when implementing ANY feature or bugfix, before writing implementation code — enforces the red-green-refactor cycle (write a failing test, watch it fail, write minimal code to pass). Trigger phrases: "add a feature", "fix this bug", "implement", "write tests", "TDD this", "should I test first". Covers new features, bug fixes, refactors, and behavior changes.
license: See ATTRIBUTION.md
metadata:
  version: "1.1.0"
  listing_id: luckiest-coder-tdd
  author: luckiest
---
